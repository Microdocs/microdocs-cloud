...
describe('@Path', () => {
  ...
  it('resolve Path variable', (done:(e?:any)=>void) => {
    ...
    let requestMock = new RequestMock((req:Request) => {
      return Observable.of(new Response({request: req}));
    });
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items/5' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve default Path variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items2/7' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve multiple Path variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items3/20/status/status-done.json' );
        done();
      }catch(e){
        done(e);
      }
...
describe('@Query', () => {
  ...
  it('resolve Query variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items?page=5' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve missing Query variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve default Query variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items2?page=20' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve multiple Query variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/items3?sort=asc&size=20&page=3' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection Format CSV', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/itemsCSV?field=name,desc' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection Format SSV', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/itemsSSV?field=name%20desc' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection Format TSV', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/itemsTSV?field=name%09desc' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection Format PIPES', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/itemsPIPES?field=name%7Cdesc' );
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection Format MULTI', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal( resp.request.path, '/itemsMULTI?field=name&field=desc' );
        done();
      }catch(e){
        done(e);
      }
...
describe('@Header', () => {
  ...
  it('resolve Header variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.deepEqual(resp.request.headers.getAll('page'), [5]);
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve missing Header variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.isFalse(resp.request.headers.has('path'));
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve default Header variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.deepEqual(resp.request.headers.getAll('page'), ['20']);
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve multiple Header variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.deepEqual(resp.request.headers.getAll('page'), [3]);
        assert.deepEqual(resp.request.headers.getAll('sort'), ['asc']);
        assert.deepEqual(resp.request.headers.getAll('size'), ['20']);
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.equal(resp.request.headers.get('field', new HeaderObjectMapper()), 'name,desc');
        done();
      }catch(e){
        done(e);
      }
  ...
  it('resolve Collection Format MULTI', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.deepEqual(resp.request.headers.getAll('field'), ['name', 'desc']);
        done();
      }catch(e){
        done(e);
      }
...
describe('@Body', () => {
  ...
  it('resolve Body variable', (done:(e?:any)=>void) => {
    // Arrange
    let requestMock = new RequestMock((req:Request) => {
      return Observable.of(new Response({request: req, rawBody: req.rawBody}));
    });
  ...
  it('resolve missing Body variable', (done:(e?:any)=>void) => {
    ...
    result.subscribe(resp => {
      try {
        assert.isUndefined( resp.rawBody);
        done();
      }catch(e){
        done(e);
      }
